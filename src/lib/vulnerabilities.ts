...
export const VULNERABLE_PACKAGES: { name: string, versions: string }[] = [
  { name: 'backslash', versions: '0.2.1' },
  { name: 'chalk-template', versions: '1.1.1' },
  { name: 'supports-hyperlinks', versions: '4.1.1' },
  { name: 'has-ansi', versions: '6.0.1' },
  { name: 'simple-swizzle', versions: '0.2.3' },
  ...
  { name: 'slice-ansi', versions: '7.1.1' },
  { name: 'color-convert', versions: '3.1.1' },
  { name: 'wrap-ansi', versions: '9.0.1' },
  { name: 'ansi-regex', versions: '6.2.1' },
  { name: 'supports-color', versions: '10.2.1' },
  { name: 'strip-ansi', versions: '7.1.1' },
  ...
  { name: '@art-ws/openapi', versions: '0.1.9, 0.1.12' },
  ...
  { name: '@art-ws/ssl-info', versions: '1.0.9, 1.0.10' },
  ...
  { name: '@nativescript-community/text', versions: '1.6.9, 1.6.10, 1.6.11, 1.6.12' },
  ...
  { name: '@nativescript-community/ui-material-core', versions: '7.2.72, 7.2.73, 7.2.74, 7.2.75' },
  { name: '@nativescript-community/ui-material-core-tabs', versions: '7.2.72, 7.2.73, 7.2.74, 7.2.75' },
  ...
  { name: '@operato/input', versions: '9.0.27, 9.0.35, 9.0.36, 9.0.37, 9.0.38, 9.0.39, 9.0.40, 9.0.41, 9.0.42, 9.0.43, 9.0.44, 9.0.45, 9.0.46' },
  { name: '@operato/layout', versions: '9.0.35, 9.0.36, 9.0.37' },
  { name: '@operato/popup', versions: '9.0.22, 9.0.35, 9.0.36, 9.0.37, 9.0.38, 9.0.39, 9.0.40, 9.0.41, 9.0.42, 9.0.43, 9.0.44, 9.0.45, 9.0.46' },
  ...
  { name: '@operato/utils', versions: '9.0.22, 9.0.35, 9.0.36, 9.0.37, 9.0.38, 9.0.39, 9.0.40, 9.0.41, 9.0.42, 9.0.43, 9.0.44, 9.0.45, 9.0.46' },
  ...
  { name: '@teselagen/react-table', versions: '6.10.19' },
  ...
  { name: 'eslint-config-teselagen', versions: '6.1.7' },
  { name: 'globalize-rpk', versions: '1.7.4' },
  { name: 'graphql-sequelize-teselagen', versions: '5.3.8' },
  { name: 'html-to-base64-image', versions: '1.0.2' },
  { name: 'json-rules-engine-simplified', versions: '0.2.1' },
  ...
  { name: 'ove-auto-annotate', versions: '0.0.9' },
  { name: 'pm2-gelf-json', versions: '1.0.4, 1.0.5' },
  { name: 'printjs-rpk', versions: '1.6.1' },
  { name: 'react-complaint-image', versions: '0.0.32' },
  { name: 'react-jsonschema-form-conditionals', versions: '0.3.18' },
  ...
  { name: 'tg-redbird', versions: '1.3.1' },
  ...
  { name: 've-bamreader', versions: '0.2.6' },
  { name: 've-editor', versions: '1.0.1' },
